...
const Join = () => {
  return (
    <section id='join' className='join bg-gradient-to-b from-custom-start to-custom-start flex flex-col pt-20 content-center pb-20'>
      ...
      <a href="#market" className='text-2xl text-center font-semibold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 p-5 rounded-3xl mt-20 flex mx-auto xs-max:text-xl xs-max:mt-14'>Join via discord</a>
