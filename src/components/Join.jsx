...
const Join = () => {
  return (
    ...
    <div className='join__content flex flex-col py-20 px-20 xxs-max:px-10 '>
      ...
      <a href="https://discord.com/" className='content__button text-2xl text-center font-semibold rounded-2xl w-60 mx-auto mt-10 p-5 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 '>Join via discord</a>
    </div>
