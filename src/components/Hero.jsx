...
const Hero = () => {
  ...
  const dataELems = data.map(elems => {
    ...
    >
      ...
      <p className='text-xl font-bold'>{elems.name} <span 
  ...
  return (
    <div className="hero__content flex flex-col items-center mt-48 sm-max:mt-60">
        ...
        <a href="#market" className='hidden text-2xl font-semibold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 pl-7 p-5 rounded-3xl mt-20 sm-max:block xs-max:text-sm text-center'>Market <AiOutlineArrowDown className='inline'/></a>
